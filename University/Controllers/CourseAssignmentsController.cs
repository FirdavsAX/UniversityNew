...
namespace University.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        {
            var universityDbContext = _context.CourseAssignments.Include(c => c.Course).Include(c => c.Instructor);
        ...
        public async Task<IActionResult> Create([Bind("Id,Room,CourseId,InstructorId")] CourseAssignment courseAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Room,CourseId,InstructorId")] CourseAssignment courseAssignment)
        {
